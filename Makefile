...
migrateup:
	migrate -path db/migration -database "postgresql://root:E7uw5Mkg2b2wIqtydl9u@simple-bank.c5vfhc0fnrhd.us-east-1.rds.amazonaws.com:5432/simple_bank" -verbose up	
